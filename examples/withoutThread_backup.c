...
static int initalize_TC_params(TC_params *tc_p,void *srcBuffer,size_t srcSize,size_t MaxDictSize,
                                size_t blockSize,size_t compressChunkSize,size_t trainChunkSize,int trainDictOnce,int regular);
/* Get size parameters. */
...
int main(int argc,char* argv[]) {
    ...
    int trainDictOnce = 0;
    if (initalize_TC_params(&tc_params,srcBuffer,srcSize,maxDictSize,blockSize,compressChunkSize,trainChunkSize,trainDictOnce,regularComp) != 0){
